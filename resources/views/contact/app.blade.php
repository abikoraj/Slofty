            ...
            <div class="col-md-8 heading_space wow fadeInRight" data-wow-delay="450ms">
                ...
                <form class="findus contact-form" id="contact-form-data" action="mailto:sloftytechnologies@gmail.com">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
                                <input type="tel" class="form-control" placeholder="Phone" name="userPhone" id="telefon"
                                    required>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
                        ...
                        <div class="col-md-12">
                            ...
                            <button type="submit" class="btn btn-blue-black btn-large btn-rounded mb-5 contact_btn"
                                id="btn_submit">Submit Request</button>
                        </div>
                    </div>
                </form>
            </div>
