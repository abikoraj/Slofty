                                ...
                                <div class="body row">
                                    {{-- <div class="form-group col-md-3">
                                        ...
                                        <input type="file" name="image" class="dropify"
                                            data-default-file="{{ asset('assets/img/testimonial/1.jpg') }}" required>
                                    </div> --}}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary btn-sm"
                                                        href="{{ route('testimonials.edit', ['testimonial' => $item->id]) }}"><i
                                                            class="zmdi zmdi-edit"></i></a>
                                                    <a class="btn btn-danger btn-sm"
                                                        href="{{ route('testimonials.delete', ['testimonial' => $item->id]) }}"><i
