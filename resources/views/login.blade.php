...
<head>
    ...
    <title>Slofty Technologies | Admin Login</title>
    <!-- Favicon-->
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    ...
                    <div class="copyright text-center">
                        ...
                        <span><a href="https://slofty.tech/" target="_blank">Slofty Technologies</a></span>
                    </div>
                </div>
                <div class="col-lg-8 col-sm-12">
                    <div class="card">
                        <img src="{{ asset('assets/aero/images/signin.svg') }}" alt="Sign In" />
                    </div>
                </div>
            </div>
        </div>
